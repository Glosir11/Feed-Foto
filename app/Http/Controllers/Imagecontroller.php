...
public function limitWords(Request $request)
{
    $text = $request->input('text'); // Ambil teks dari request

    // Batasi teks menjadi maksimal 100 kata
    $limitedText = Str::words($text, 100, '');

    return view('images.create', ['limitedText' => $limitedText]);
